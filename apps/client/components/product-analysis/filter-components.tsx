...
export default function FilterComponent({ onFiltered, onCleared, brands }: Props) {
  const [state, dispatch] = useReducer((state: FilterState, action: FilterAction) => {
    switch (action.type) {
  ...
  return (
    <div className="px-6 py-4 rounded-t-xl flex gap-y-6 flex-col lg:flex-row bg-filter_section-background">
      ...
      <div className="flex justify-end items-center pl-5 mt-5">
        <div className="flex gap-3">
          ...
          <Button onClick={handleAnalyze} disabled={isAnalyzeDisabled} className="rounded-xl">
